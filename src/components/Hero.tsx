...
export default function Hero() {
  return (
    <section className="flex items-center justify-between gap-7 md:px-8 md:py-8 w-full bg-linear-to-r from-blue-100 to-blue-50">
      ...
      <img
        ...
        alt="Leadership"
        className="hidden lg:block size-1/2 object-cover object-center opacity-1 cursor-pointer transition duration-700 shadow-xl rounded-xl hover:transform hover:scale-105"
      />
    </section>
  );
}
